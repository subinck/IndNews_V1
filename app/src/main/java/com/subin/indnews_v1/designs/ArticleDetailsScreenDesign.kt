...
import com.subin.indnews_v1.model.response.Source

@Composable
fun ArticleDetailsScreen(navController: NavController,att:Article) {
    ...
    Scaffold(
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    shareDataFromArticle(context, att)
                },
        ...
        Column(
            ...
            Card(
                ...
                Image(
                    painter = rememberImagePainter(att.urlToImage),
 ...
 fun shareDataFromArticle(context: Context,article:Article){
...
@Composable
fun ArticleScreenDetailsPreview(){
    val context= LocalContext.current
    val navController:NavController=NavController(context)
    val source: Source= Source("","")
    val at:Article=Article("","","","",source,"","","")
     ArticleDetailsScreen(navController =navController,at)
}
